...
const { isLoginType, registerFrom } = storeToRefs(useAuthStore())
...
.paopao {
  ...
  box-shadow: inset 0 0 20px #fff, inset 10px 0 50px #eaf5fc,
    inset 80px 0 60px #56afd8, inset -20px -60px 100px #f9f6de,
